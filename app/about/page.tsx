...
type AboutContentProps = {
  ...
  bio: string;
  image: string;
  expertise: AboutExpertiseProps[]   // array as returned
  tech_stack: string[]; 
}
...
type AboutExpertiseProps = {
  id: string;
  title: string;
  proficiency_level: string;   // comes as a string ("81"), can convert to number if preferred
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">{aboutContent?.hero.headline}</h1>
          <p className="text-xl text-secondary mb-16">{aboutContent?.hero.subheadline}</p>
